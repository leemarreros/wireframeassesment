...
var BarIndicator = (function (_Component) {
    _inherits(BarIndicator, _Component);

    function BarIndicator(props) {
        _classCallCheck(this, BarIndicator);

        _get(Object.getPrototypeOf(BarIndicator.prototype), 'constructor', this).call(this, props);
        this.state = {
            width: 1
        };
    }
    ...
    _createClass(BarIndicator, [{
        ...
        value: function componentDidMount() {
            if (this.props.size) {
                var _el = document.getElementsByClassName('bar-indicator-wrapper-' + this.props.size);
                _el[0].onresize = function () {
                    console.log('resizing');
                };
                console.log(_el);
                if (_el.length) {
                    this.setState({ width: _el[0].offsetWidth });
                }
                return;
            }

            var el = document.getElementsByClassName('bar-indicator-wrapper');
            if (el.length) {
        ...
        value: function render() {
            ...
            var portion = _props.portion;

            return _react2['default'].createElement(
                'div',
                {
                    style: { backgroundColor: '' + color },
                    className: 'bar-indicator-content' },
                ' '
            );
        }
    }]);
...
},{"../mock-data":3,"react":164,"react-dom":35}],2:[function(require,module,exports){
'use strict';
...
var _wireframesList = require('./wireframes/List');

var _wireframesList2 = _interopRequireDefault(_wireframesList);

var _wireframesSummary = require('./wireframes/Summary');

var _wireframesSummary2 = _interopRequireDefault(_wireframesSummary);

var _wireframesMonth = require('./wireframes/Month');

var _wireframesMonth2 = _interopRequireDefault(_wireframesMonth);
...
var Wireframe = (function (_React$Component) {
    ...
    function Wireframe(props) {
        ...
        _get(Object.getPrototypeOf(Wireframe.prototype), 'constructor', this).call(this, props);
        this.state = {
            summarypage: false,
            monthpage: false
        };
    ...
    _createClass(Wireframe, [{
        key: 'openSummaryPage',
        value: function openSummaryPage() {
            this.setState({ summarypage: true, monthpage: false });
        }
    }, {
        key: 'closeSummaryPage',
        value: function closeSummaryPage() {
            this.setState({ summarypage: false, monthpage: false });
        }
    }, {
        key: 'openMonthPage',
        value: function openMonthPage() {
            this.setState({ summarypage: true, monthpage: true });
        }
    }, {
        key: 'closeMonthPage',
        value: function closeMonthPage() {
            this.setState({ summarypage: true, monthpage: false });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_wireframesList2['default'], { onClickSummary: function () {
                        return _this.openSummaryPage();
                    } }),
                !!this.state.summarypage && _react2['default'].createElement(_wireframesSummary2['default'], {
                    onCloseSummary: function () {
                        return _this.closeSummaryPage();
                    },
                    openMonthPage: function () {
                        return _this.openMonthPage();
                    } }),
                !!this.state.monthpage && _react2['default'].createElement(_wireframesMonth2['default'], { closeMonthPage: function () {
                        return _this.closeMonthPage();
                    } })
            );
        }
    }]);
...
_reactDom2['default'].render(_react2['default'].createElement(Wireframe, null), document.getElementById('react'));

},{"./wireframes/List":4,"./wireframes/Month":5,"./wireframes/Summary":6,"react":164,"react-dom":35}],3:[function(require,module,exports){
'use strict';
...
var mockData = {
    ...
    month: [{
        expenditure: 'Bed Bath & Beyond',
        date: '01/15/2013',
        amount: '$238.57',
        balance: '$1,764.98'
    }, {
        expenditure: 'Angel Island',
        date: '01/15/2013',
        amount: '$238.57',
        balance: '$1,764.98'
    }, {
        expenditure: 'Freshroll',
        date: '01/15/2013',
        amount: '$238.57',
        balance: '$1,764.98'
    }, {
        ...
        expenditure: 'Wholefoods',
        date: '01/15/2013',
        amount: '$238.57',
        balance: '$1,764.98'
    }, {
        expenditure: 'Starbucks',
        date: '01/15/2013',
        amount: '$238.57',
        balance: '$1,764.98'
    }],
    content_head: [{
        description: '• Minimun payment due on 01/01/2013:',
        amount: '$000.00'
    }, {
...
var _componentsBarIndicator = require('../components/BarIndicator');

var _componentsBarIndicator2 = _interopRequireDefault(_componentsBarIndicator);
...
var ItemList = (function (_Component) {
    ...
    _createClass(ItemList, [{
        ...
        value: function render() {
            ...
            var img = _props$data.img;
            var type = _props$data.type;
            var amount = _props$data.amount;
            var barIndicator = _props$data.barIndicator;
            var onClickSummary = this.props.onClickSummary;

            return _react2['default'].createElement(
                'div',
                { className: 'item-list', onClick: function () {
                        onClickSummary();
                    } },
                _react2['default'].createElement(
                    'div',
                    { className: 'icon-item-list' },
                    _react2['default'].createElement('img', { className: 'image-item-list', src: '../img/' + img })
                ),
                _react2['default'].createElement(
                    'div',
                ...
                !!barIndicator && _react2['default'].createElement(
                    'div',
                    { className: 'bar-indicator-wrapper' },
                    _react2['default'].createElement(_componentsBarIndicator2['default'], { color: '#2981E8', portion: 0.65 })
                )
            );
        }
    }]);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _mockData.listData.map(function (data, i) {
                    return _react2['default'].createElement(ItemList, { data: data, key: i, onClickSummary: function () {
                            _this.props.onClickSummary();
                        } });
                })
            );
        }
...
},{"../components/BarIndicator":1,"../mock-data":3,"react":164,"react-dom":35}],5:[function(require,module,exports){
'use strict';
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'div',
                        { className: 'leave-month-page' },
                        _react2['default'].createElement('img', { onClick: function () {
                                return _this.props.closeMonthPage();
                            }, className: 'image-item-list', src: '../img/back-icon.png' })
                    )
                ),
                _react2['default'].createElement('div', { className: 'top-column-names' }),
                _react2['default'].createElement(
                    'div',
                    { className: 'content-month' },
                    _mockData.month.map(function (data, i) {
                        return _react2['default'].createElement(
                            'div',
                            { className: 'row-data-month', key: i },
                            _react2['default'].createElement(
                                'div',
                                { className: 'icon-item-month' },
                                _react2['default'].createElement('div', { className: 'circle-month' })
                            ),
                            _react2['default'].createElement(
                                'div',
...
},{"../mock-data":3,"react":164,"react-dom":35}],6:[function(require,module,exports){
'use strict';
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement('img', { onClick: function () {
                                return _this.props.onCloseSummary();
                            }, className: 'image-item-list', src: '../img/back-icon.png' })
                    ),
                    _react2['default'].createElement(
                        'div',
                        { className: 'bar-indicator-wrapper-large' },
                        _react2['default'].createElement(_componentsBarIndicator2['default'], { color: '#50E3C2', portion: 0.65, size: 'large' })
                    ),
                    _react2['default'].createElement(
                        'div',
                        { className: 'content-head' },
                        _mockData.content_head.map(function (data, i) {
                            return _react2['default'].createElement(
                                'div',
                                { key: i, className: 'content-head-row' },
                                _react2['default'].createElement(
                                    'h1',
                                    null,
                                    data.description
                ...
                _react2['default'].createElement(
                    ...
                    _mockData.summaryData.map(function (data, i) {
                        return _react2['default'].createElement(
                            'div',
                            { className: 'summary-row', key: i, onClick: function () {
                                    return _this.props.openMonthPage();
                                } },
                            _react2['default'].createElement(
                                'div',
                                { className: 'row-icon' },
                            ...
                            _react2['default'].createElement(
                                'div',
                                { className: 'bar-indicator-wrapper-medium' },
                                _react2['default'].createElement(_componentsBarIndicator2['default'], { color: '#50E3C2', portion: 0.45 + i * 0.1, size: 'medium' })
                            )
                        );
                    })
                )
...
},{"../components/BarIndicator":1,"../mock-data":3,"react":164,"react-dom":35}],7:[function(require,module,exports){
(function (process){
/**
